...
def decode_and_crop(image_buffer, bbox= None, scope= None, ):
  """ fused decode and crop image function
  ...
  return:
    ...
    distort_bbox: distorted bbox
  """
  # Extract image shape from raw JPEG image buffer.
  with tf.name_scope(scope, 'decode_and_crop'):
